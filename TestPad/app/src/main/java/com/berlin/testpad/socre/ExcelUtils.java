...
//                cell1.setCellStyle(cellStyles.get(3));
    ...
    //写excel
    public static void writeExecleToFile(Context context, ScoreModel scoreModel, String path, String name) {
...
//            Toast.makeText(context,"数据有误,写入文件失败",Toast.LENGTH_SHORT).show();
        ...
        writeFile(workbook, path + File.separator + name + SUFFIX, context);
    }
