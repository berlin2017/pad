...
public class MainFragment8 extends Fragment {
    ...
    public static MainFragment8 mainFragment;
    ...
    public static MainFragment8 newInstance(){
        if (mainFragment==null)
            mainFragment = new MainFragment8();
        return mainFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.main_fragment8,container,false);
        return view;
    }
