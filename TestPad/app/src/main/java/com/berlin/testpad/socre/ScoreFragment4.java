...
public class ScoreFragment4 extends BaseFragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_score_table4, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (score_Model != null) {
            if (!TextUtils.isEmpty(score_Model.getFragment4())) {
                Gson gson = new Gson();
                InputModel4 inputModel2 = gson.fromJson(score_Model.getFragment4(), InputModel4.class);
    ...
    public void updateEdit(InputModel4 inputModel2) {
        ...
        suggest_editText8.setText("");
        suggest_editText9.setText("");
        suggest_editText10.setText("");
    ...
    public InputModel4 save() {
        if(verfyEdit(editText1, 15, 0)&& verfyEdit(editText2, 10, 0)&& verfyEdit(editText3, 30, 0)&&verfyEdit(editText4, 10, 0)&&verfyEdit(editText5, 25, 0)&&
                verfyEdit(editText6, 25, 0)&&verfyEdit(editText7, 15, 0)&&verfyEdit(editText8, 55, 0)&&verfyEdit(editText9, 25, 0)&&verfyEdit(editText10, 70, 0)){
